...
#
# ⚠️⚠️ 2026-09-23 首次实跑暴露 3 处**自身缺陷**：会崩在第 3 步的 rebuild 判定（NameError），
#      且另外两条判据（向量维度 / nginx 上限）会造假警报 —— **修复前不要把它当可用工具**。
#      现象、根因与待定方案见 docs/agent-log/20260923-首次实跑deploy失败.md
#
